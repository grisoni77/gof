...
/**
 * Description of EnchantedMazeBuilder
 *
 * @author cris
 */
class EnchantedMazeBuilder extends AbstractMazeBuilder
{
    /**
     * @inheritdoc 
     */
    ...
    public function buildRoom($number)
    {
        ...
        {
            $room = new \GOF\Creationals\Maze\EnchantedRoom($number);
    ...
    public function buildDoor($r1, $r2, $direction)
    {
        ...
        $door = new \GOF\Creationals\Maze\DoorNeedingSpell($room1, $room2);
        // set new room sides
